  ...
  return (
    <div className="res-card-container">
      <div className="res-image">
        <img src= {"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + resData.data.cloudinaryImageId} />
      </div>
      <div className="res-info">
        <p> {resData.data.deliveryTime} </p>
        <p> {resData.data.cuisines} </p>
        <p> {resData.data.costForTwoString} </p>
